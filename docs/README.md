...
- MindVision XGC + R5D 5 kHz trigger/strobe wiring, Rigol acceptance,
  calibrated pulse widths, and exposure overlap — see
  [howto/mindvision-xgc-r5d-led-strobe.md](howto/mindvision-xgc-r5d-led-strobe.md)
