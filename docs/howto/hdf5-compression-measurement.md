...
| Rig PC, i9-13900 24 cores / 32 logical, recordings on a `D:` SATA HDD (2026-09-26) | Conan 1.14.6, threadsafe=0 (TD-17) | Capability test passes, S1 growth 0.00 %. Idle gzip-1: 84/127/256 MB/s on 1/2/4 threads; to the HDD: 63/129/242 MB/s. Step 3a: 12 soaks complete with zero loss. gzip-1 during the run: 35/68/99/129 MB/s on 1/2/3/4 threads, and every T passes in both modes, so `auto = clamp(hw/2, 1, 4)` = 4 is confirmed. HDFView and MATLAB: not available on the rig. 3b (real camera): skipped. [Evidence](../evidence/2026-09-26-compression-headroom-rig/README.md) |
