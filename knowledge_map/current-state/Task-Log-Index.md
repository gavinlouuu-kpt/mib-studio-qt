...
> Index into the dated task records at `knowledge_map/task/`. These are
> design notes, bug reports, and task plans written by past contributors.
> Useful for historical context — **do not rewrite** them.
...
- `task/preview-json-table-toggle.md`
- `task/playback_display_integration.md`
...
fix_hdfreviewtab_linker_error.md
fps_mbs_zero.md
menu_settings_dialog.md
mock_camera_dev_mode.md
playback_display_integration.md
preview-json-table-toggle.md
qt_qpa_platform_plugin_missing_windows.md
review_2gb_scalability.md
review_hdf_thumbnail_spacer_crash.md
review_logging_improvements.md
ui-status-stats.md
```
