...
function packet(overrides = {}, payload = [11,22,0,255]) {
  const meta = {valid: true, width: 2, height: 1, image_bytes: 2, mask_bytes: 2, source: 'live_processing', frame_index: '18446744073709551614', source_timestamp: '42', source_timestamp_unit: 'source_native_unknown', host_timestamp_us: '0', processing_session: '4', store_generation: '9', recipe_sha256: 'a'.repeat(64), primary_bounds: [0,0,1,1], roi: [0,0,2,1], contours: [[[0,0],[1,0]]], contours_truncated: false, primary_object_valid: true, primary_object_target: false, ...overrides};
