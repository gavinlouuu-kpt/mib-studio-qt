import { CAMERA_STATES, FRAME_READY_SOURCES, COMMAND_TYPES, ERROR_SOURCES, EVENT_PAYLOADS, EXPERIMENT_STATES,
  JSON_TRANSPORT, OPERATION_KINDS, OPERATION_STATES, RECORDING_STATES } from "./bridgeContract";
...
export type BridgeEvent =
  ...
  | ({kind:"ExperimentStatus"; state:number; validBuffered:string; invalidBuffered:string; validSaved:string; invalidSaved:string; startTimeNs:string; endTimeNs:string; droppedValid:string; droppedInvalid:string; flushing:boolean; cancelled:boolean} & Message)
